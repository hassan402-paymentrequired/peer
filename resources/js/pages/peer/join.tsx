...
export default function JoinPeer({ peer, players }: { peer: Peer; players: PlayerGroup[] }) {
            ...
            <main className="p-5">
                ...
                <div className="border-border/10 bg-[var(--clr-surface-a10)] py-3">
                    <div className="flex items-center justify-between">
                        <h2 className="font-bold tracking-wider text-[var(--clr-surface-a50)]">{peer.name}</h2>
                                                            ...
                                                            <div className="mb-3 flex w-full items-center justify-between">
                                                                ...
                                                                <div className="flex items-center">
                                                                    ...
                                                                    <div className="flex items-center justify-center gap-3">
                                                                        ...
                                                                        <div>
                                                                            <div className="text-muted-white text-base font-bold">
                                                                                {player.player_name}
                                                                            </div>
