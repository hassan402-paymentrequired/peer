...
return new class extends Migration
{
    ...
    {
        Schema::create('tournament_user_squards', function (Blueprint $table) {
            $table->id();
            $table->foreignId('tournament_user_id')->constrained('tournament_users')->cascadeOnDelete();
    ...
    {
        Schema::dropIfExists('tournament_user_squards');
    }
};
